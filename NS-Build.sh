...
Update_Scripts() {
    ...
    sudo wget https://github.com/NeoCircuit-Studios/Wine-Tools/releases/download/sys/NS-Update.sh
    sudo rm Update.sh
...
sudo wget https://github.com/NeoCircuit-Studios/Wine-Tools/releases/download/sys/install-configure-FS-from-source.sh
sudo wget https://github.com/NeoCircuit-Studios/Wine-Tools/releases/download/sys/install-configure-FS.sh
sudo wget https://github.com/NeoCircuit-Studios/Wine-Tools/releases/download/sys/Just-Install-Wine.sh
sudo wget https://github.com/NeoCircuit-Studios/Wine-Tools/releases/download/sys/Install-FS-Cdrom.sh
...
run_and_make_server_Short() {
  ...
  sudo wget https://github.com/NeoCircuit-Studios/Wine-Tools/releases/download/sys/NS-Run-Dedicated-Server.sh
